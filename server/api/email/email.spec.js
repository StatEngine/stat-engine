...
describe('setMergeVars()', () => {
  ...
  it.skip('should set merge vars', () => {
    const req = {
      ...
      fireDepartment: { get: () => { return { name: 'Richmond', firecares_id: '93345', timezone: 'US/Eastern' }; } },
      reportOptions: {
    ...
    // TODO: the non-existing function was commented out
    // setMergeVars(req);
  });

  it('should calculate time range', () => {
    const tr = calculateTimeRange({ startDate: '2018-05-16T08:00:00-04:00', endDate: '2018-05-17T08:00:00-04:00', timeUnit: TimeUnit.Shift });
  ...
  // TODO: fix me
  // start:
  // Expected :2018-05-16T08:00:00-04:00
  // Actual   :2018-05-16T00:00:00-04:00
  //
  // end:
  // Expected :2018-05-17T08:00:00-04:00
  // Actual   :2018-05-17T00:00:00-04:00
  it.skip('should calculate time range with no end date provided (DAY)', () => {

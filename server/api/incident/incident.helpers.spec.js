import { generateTextualSummaries,
  generateAnalysis } from './incident.helpers';
...
describe('generateSummary', () => {
  const incident = {
    ...
    version: '0.0.1',
    durations: {
      alarm_answer: { seconds: 0 },
      alarm_processing: { seconds: 8 },
      alarm_handling: { seconds: 8 },
      turnout: { seconds: 63 },
      travel: {
        seconds: 298,

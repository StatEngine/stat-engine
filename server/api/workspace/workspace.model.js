...
export default function(sequelize, DataTypes) {
  ...
  Workspace.prototype.buildSlug = function() {
  ...
  Workspace.prototype.getKibanaIndex = function(fireDepartment) {
    return `.kibana_${fireDepartment.firecares_id}_${this.slug}`;
  };

  Workspace.prototype.getDashboards = async function(kibanaApi) {
  ...
  Workspace.prototype.addDashboards = async function({ dashboards, kibanaApi }) {
  ...
  Workspace.prototype.addFixtures = async function({ fixtureTemplates, generateUniqueId = false, kibanaApi }) {
  ...
  Workspace.prototype.removeFixtures = async function({ type, ids, kibanaApi }) {
    // Update Kibana.

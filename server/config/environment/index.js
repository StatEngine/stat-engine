...
const all = {
  ...
  mailSettings: {
    serverEmail: 'noreply@nfors.org',
    requestUsernameTemplate: 'nfors-analytics-request-username',
    resetPasswordTemplate: 'nfors-analytics-reset-password',
    newUserTemplate: 'nfors-analytics-getting-started',
    newUserByDepartmentAdminTemplate: 'nfors-analytics-new-user-by-department-admin',
    newReportTemplate: 'new-report',
    departmentAccessRequestedTemplate: `${emailPrefix}nfors-analytics-department-access-requested`,
    departmentAccessApprovedTemplate: `${emailPrefix}nfors-analytics-department-access-approved`,
    departmentAccessRevokedTemplate: `${emailPrefix}nfors-analytics-department-access-revoked`,
    departmentAccessRejectedTemplate: `${emailPrefix}nfors-analytics-department-access-rejected`,
    timeRangeTemplate: 'nfors-analytics-timerange',

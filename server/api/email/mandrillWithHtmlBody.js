...
export function sendEmail(to, subject, htmlBody, merge_vars, test, metadata) {
  let apiKey;

  if (test) { apiKey = config.mailSettings.mandrillTestAPIKey; } else { apiKey = config.mailSettings.mandrillAPIKey; }
